  ...
  <div class="font-sans bg-white">
    ...
    <section class="bg-[#2ECC71] text-white pt-10 pb-4 md:pt-14 md:pb-6 px-6 md:px-12 overflow-hidden">
      <div class="container mx-auto max-w-[1100px] grid md:grid-cols-[1fr_0.95fr] gap-6 lg:gap-7 items-start">
        ...
        >
          <img
            src="~/assets/img/api/img_principal_api.png"
            alt="API LeekPay"
        ...
        <div class="bg-[#E9F8EF] rounded-2xl p-6 md:p-8 grid md:grid-cols-[1.05fr_0.95fr] gap-8 items-center">
          ...
          >
            <img
              ...
              class="w-full max-w-[260px] sm:max-w-[300px] md:max-w-[360px] rounded-[22px] border border-[#2ECC71]"
            />
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div class="relative grid grid-cols-1 md:grid-cols-4 justify-items-center gap-y-9 md:gap-y-0 md:gap-x-4">
            <div class="flex w-full max-w-[300px] flex-col items-center text-center">
              ...
              <p class="mt-3 text-[17px] md:text-[18px] text-[#2ECC71] font-semibold leading-[1.2] md:whitespace-nowrap">Découvrez<br class="hidden md:block" /> la documentation</p>
            </div>
            ...
            <div class="flex w-full max-w-[300px] flex-col items-center text-center">
              ...
              <p class="mt-3 text-[17px] md:text-[18px] text-[#2ECC71] font-semibold leading-[1.2] md:whitespace-nowrap">Intégrez<br class="hidden md:block" /> l'API</p>
            </div>
            ...
            <div class="flex w-full max-w-[300px] flex-col items-center text-center">
              ...
              <p class="mt-3 text-[17px] md:text-[18px] text-[#2ECC71] font-semibold leading-[1.2] md:whitespace-nowrap">Configurez<br class="hidden md:block" /> &amp; Partagez</p>
            </div>
            ...
            <div class="flex w-full max-w-[300px] flex-col items-center text-center">
              ...
              <p class="mt-3 text-[17px] md:text-[18px] text-[#2ECC71] font-semibold leading-[1.2] md:whitespace-nowrap">Le client<br class="hidden md:block" /> paie</p>
            </div>
          </div>
        </div>
      </div>
