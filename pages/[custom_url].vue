    ...
    <div class="w-full md:w-1/2  flex items-center justify-center p-2 md:p-2">
      <div class="w-full max-w-md">
        ...
        <div v-else-if="paymentData" class="bg-white p-2 md:p-8 rounded-sm shadow-sm border border-gray-100">
          ...
          <div v-if="staticDisabledMethods.length > 0" class="mt-2 bg-yellow-50 border border-yellow-200 rounded-lg p-3">
...
const staticDisabledMethods = ['card', 'paypal'] // Désactivés temporairement
