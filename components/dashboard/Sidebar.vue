<template>
  <div class="w-full bg-white border-r border-gray-200 h-full flex flex-col">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3">
      ...
      <!-- LIENS DE PAIEMENT -->
      <div class="mb-4">
        <div class="flex items-center bg-gray-50 justify-between px-3 py-2.5 mb-1" v-if="!collapsed">
   ...
   <!-- PAGES DE VENTE -->
      <div class="mb-4">
        <div class="flex items-center bg-gray-50 py-2.5 justify-between px-3 mb-1" v-if="!collapsed">
      ...
      <div class="mb-4">
        <button 
          ...
          class="w-full flex items-center bg-gray-50 py-2.5 justify-between px-3 mb-1 text-[10px] font-semibold text-gray-400 uppercase tracking-wider hover:text-gray-600 transition"
        >
          <span>Finances</span>
...
const adminItems = computed(() => [
  ...
  { id: 'dashboard/admin/withdrawal-options', label: 'Opérateurs retrait', icon: ArrowLeftRightIcon }
])
</script>
